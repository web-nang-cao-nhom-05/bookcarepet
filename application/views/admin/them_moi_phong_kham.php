...
<head>
    ...
    <title>Thêm Mới Phòng Khám</title>
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div class="page-title-icon">
                                    <i class="pe-7s-science btn-icon-wrapper">
                                    </i>
                                </div>
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"></h5>
                                    <form class="">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tên phòng khám</label>
                                            <div class="col-sm-10"><input name="tieu_de" id="exampleEmail" placeholder="Tên phòng khám" type="email" class="form-control"></div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleSelectMulti" class="col-sm-2 col-form-label">Địa chỉ</label>
                                            <div class="col-sm-10"><select multiple="" name="mo_ta_ngan" id="exampleSelectMulti" class="form-control"></select></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleFile" class="col-sm-2 col-form-label">Hình ảnh</label>
                                            <div class="col-sm-10"><input name="file" id="exampleFile" type="file" class="form-control-file">
                                                <small class="form-text text-muted">Chọn file ảnh</small>
                                            </div>
                                        </div>
                                        
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Người tạo</label>
                                            <div class="col-sm-10"><input name="tieu_de" id="exampleEmail" placeholder="Người tạo" type="email" class="form-control"></div>
                                        </div>
