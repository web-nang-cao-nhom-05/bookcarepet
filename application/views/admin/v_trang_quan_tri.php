                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-3 widget-chart">
                                            ...
                                            <div class="widget-numbers"><span>10k</span></div>
                                            <div class="widget-subheading">Tổng lượt xem</div>
                                            <div class="widget-description text-success">
                                                <i class="fa fa-angle-up ">
        
                                                </i>
                                                <span class="pl-1"><span>30%</span></span></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="./quan_tri_san_pham.html">
                                            ...
                                            <div class="widget-subheading">Tống dịch vụ cung cấp cho thú cưng</div>
                                            <div class="widget-description text-warning"><span class="pr-1"><span>40%</span></span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="card mb-3 widget-chart">
                                            ...
                                            <div class="widget-numbers"><span>20</span></div>
                                            <div class="widget-subheading">Tổng lượng phản hồi/góp ý</div>
                                            <div class="widget-description text-primary"><span class="pr-1">20%</span>
                                                <i class="fa fa-angle-up ">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="card mb-3 widget-chart">
                                            ...
                                            <div class="widget-subheading">Tổng số người đăng ký book lịch</div>
                                            <div class="widget-description text-info">
                                                <i class="fa fa-arrow-right ">
        
                                                </i>
                                                <span class="pl-1">25%</span></div>
                                        </div>
                                        </a>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card mb-3 widget-chart">
                                            ...
                                            <div class="widget-numbers"><span>24</span></div>
                                            <div class="widget-subheading">Tổng số các phòng khám liên kết</div>
                                            <div class="widget-description text-danger"><span class="pr-1">15%</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-3 widget-chart">
                                            ...
                                            <div class="widget-subheading">Tổng số tin tức</div>
                                            <div class="widget-description text-focus">
                                                <i class="fa fa-arrow-left ">
        
                                                </i>
                                                <span class="pl-1">35%</span></div>
                                        </div>
                                    </div>
                                </div>
