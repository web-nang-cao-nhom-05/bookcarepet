                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="main-card mb-2 card">
                                ...
                                <div class="card-body"><h5 class="card-title"></h5>
                                    <form method="POST" action="<?=base_url();?>admin/quan_tri_phong_kham/thuc_hien_sua_phong_kham">
                                        <div class="position-relative row form-group"><label  class="col-sm-2 col-form-label">Mã phòng khám*</label>
                                            <div class="col-sm-10"><input name="ma_phong_kham"  value="<?=$phong_kham->ma_phong_kham;?>" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label  class="col-sm-2 col-form-label">Tên phòng khám *</label>
                                            <div class="col-sm-10"><input name="ten_phong_kham"  value="<?=$phong_kham->ten_phong_kham;?>"  class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label  class="col-sm-2 col-form-label">Số điện thoại*</label>
                                            <div class="col-sm-10"><input name="sdt"  value="<?=$phong_kham->sdt;?>"  class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Địa chỉ</label>
                                            <div class="col-sm-10"><input name="dia_chi" value="<?=$phong_kham->dia_chi;?>" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10"><input name="email" value="<?=$phong_kham->email;?>"  class="form-control"></div>
                                        
                                        
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2">
                                                <button class="btn btn-secondary">Submit</button>
                                                <input name="ma_phong_kham" type="hidden" value="<?=$phong_kham->ma_phong_kham;?>">
                                            </div>
                                        </div>
                                        </div>
                                    </form>
