                            ...
                            <div>
                                <form method="POST" action="<?=base_url();?>admin/dang_nhap/kiem_tra_dang_nhap">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="examplePassword" class="">Mật khẩu</label><input name="mat_khau"  placeholder="Nhập mật khẩu..." type="password"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto">
                                            <a href="./kiem_tra_tai_khoan" class="btn-lg btn btn-link">Quên mật khẩu</a>
