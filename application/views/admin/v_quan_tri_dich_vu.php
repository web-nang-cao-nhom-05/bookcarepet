...
<head>
    ...
    <title>Quản trị dịch vụ | BOOKCAREPET</title>
                ...
                <div class="app-main__inner">
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div>
                            <a href="./quan_tri_dich_vu/them_moi_dich_vu">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body py-3">        
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold"><?=$row1->ten_dich_vu;?></a></div>
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_dich_vu/sua/<?=$row1->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_dich_vu/xoa/<?=$row1->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body py-3">        
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold"><?=$row2->ten_dich_vu;?></a></div>
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_dich_vu/sua/<?=$row2->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Sửa
                                                </span>
                                                <span class="ladda-spinner">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_dich_vu/xoa/<?=$row2->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Xóa
                                                </span>
                                                <span class="ladda-spinner">
                 ...
                 <div class="card mb-3">
                        ...
                        <div class="card-body py-3">        
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold"><?=$row3->ten_dich_vu;?></a></div>
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-6 align-items-center">
                                            ...
                                            <div class="media-body flex-truncate ml-1">
                                                ...
                                                <div class="text-muted small text-truncate"><?=$row3->thoi_gian;?></div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_dich_vu/sua/<?=$row3->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Sửa
                                                </span>
                                                <span class="ladda-spinner">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_dich_vu/xoa/<?=$row3->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Xóa
                                                </span>
                                                <span class="ladda-spinner">
