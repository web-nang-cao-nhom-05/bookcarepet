                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="main-card mb-3 card">
                                ...
                                <div class="card-body"><h5 class="card-title"></h5>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_san_pham/thuc_hien_them_moi_san_pham';?>">
                                    ...
                                    <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Phòng khám</label>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Tên sản phẩm</label>
                                            <div class="col-sm-8"><input name="txttensp" class="form-control"></div>
                                        </div>
