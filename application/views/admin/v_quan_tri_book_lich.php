              ...
              <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="app-inner-layout">
                        ...
                        <div class="app-inner-layout__wrapper">
                                    ...
                                    <div class="app-inner-layout__top-pane">
                                        <div class="pane-left">
                                                ...
                                                <button class="ladda-button mb-2 mr-2 btn-pill btn btn-danger" data-style="expand-right">
                                                    <span class="ladda-label" > <a href="./quan_tri_book_lich/them_moi_book_lich"> Thêm mới</a> </span>
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Danh sách book lịch</h5>
                    ...
                    <?php foreach ($book_lich as $row1) {
                        ;?>
                                <tbody>
                                <tr>
                                <td><?=$row1->ma_book_lich;?></td>  
                                <td><?=$row1->ho_ten;?></td>
                                <td><?=$row1->sdt;?></td>
                                <td><?=$row1->email;?></td>
                                <td><?=$row1->dia_chi;?></td>
                                <td><?=$row1->ten_dich_vu;?></td>
                                <td><?=$row1->ten_phong_kham;?></td>
                                <td><?=$row1->giong_thu_cung;?></td>
                                <td><?=$row1->ngay_kham;?></td>
                                <td>
                            <a href="./quan_tri_book_lich/sua/<?=$row1->ma_book_lich;?>">
                                <button class="mb-2 mr-2 btn-icon btn-icon-only btn btn-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i></button>
                           
                            </a>

                            <a href="./quan_tri_book_lich/xoa/<?=$row1->ma_book_lich;?>">
