...
<head>
    ...
    <title>Thêm mới dịch vụ | BOOKCAREPET</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">THÊM MỚI DỊCH VỤ</h5>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_dich_vu/thuc_hien_them_moi_dich_vu';?>">

                                    <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Phòng khám</label>
                                            <div class="col-sm-8">

                                            <select id="txtMaphongkham" name="txtMaphongkham" class="form-control">
                                            <?php 
                                                // Hiển thị ra được loại sinh viên (thông qua câu lệnh lặp)

                                                foreach ($ma_phong_kham as $phong_kham) {
                                            ;?>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Tên dịch vụ</label>
                                            <div class="col-sm-8"><input name="txtTendv" class="form-control"></div>
                                        </div>
                                        

                                        
                                        <div class="position-relative row form-group"><label for="exampleFile" class="col-sm-4 col-form-label">Ảnh</label>
                                            <div class="col-sm-8"><input name="txtAnhMinhHoa" id="exampleFile" type="file" class="form-control-file">
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Người tạo</label>
                                            <div class="col-sm-8"><input name="txtNguoiTao" class="form-control"></div>
                                        </div>
