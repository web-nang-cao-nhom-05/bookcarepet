...
<head>
    ...
    <title>Sửa dịch vụ | K19HTTTA</title>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card">
                                <div class="card-body"><h5 class="card-title">SỬA DỊCH VỤ</h5>
                                    <div>
                                    <form method="POST" action="<?=base_url().'admin/quan_tri_dich_vu/thuc_hien_sua_dich_vu';?>">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Tên dịch vụ</label>
                                            <div class="col-sm-8">
                                                <input name="txtTendv" class="form-control" value="<?=$dich_vu->ten_dich_vu;?>">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Phòng khám</label>
                                            <div class="col-sm-8"><input name="txtMaphongkham" class="form-control"></div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Người tạo</label>
                                            <div class="col-sm-8">
                                                <input name="txtNguoiTao" class="form-control" value="<?=$dich_vu->nguoi_tao;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2">
                                                ...
                                                <input name="txtID" type="hidden" value="<?=$dich_vu->ma_dv;?>">
                                            </div>
                                        </div>
                                    </form>
                                    </div>
