                        ...
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card">
                                <div class="card-body"><h5 class="card-title">SỬA SẢN PHẨM</h5>
                                    <div>
                                    <form method="POST" action="<?=base_url().'admin/quan_tri_san_pham/thuc_hien_sua_san_pham';?>">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Tên sản phẩm</label>
                                            <div class="col-sm-8">
                                                <input name="txttensp" class="form-control" value="<?=$san_pham->ten_sp;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Người tạo</label>
                                            <div class="col-sm-8">
                                                <input name="txtNguoiTao" class="form-control" value="<?=$san_pham->nguoi_tao;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2">
                                                ...
                                                <input name="txtID" type="hidden" value="<?=$san_pham->ma_sp;?>">
                                            </div>
                                        </div>
                                    </form>
                                    </div>
