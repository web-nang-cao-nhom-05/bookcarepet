...
<head>
    ...
    <title>Quản trị sản phẩm | BOOKCAREPET</title>
            ...
            <div class="app-sidebar sidebar-shadow">
                ...
                <div class="app-main__inner">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_san_pham/sua/<?=$row1->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_san_pham/xoa/<?=$row1->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body py-3">        
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold"><?=$row2->ten_san_pham;?></a></div>
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_san_pham/sua/<?=$row2->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Sửa
                                                </span>
                                                <span class="ladda-spinner">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_san_pham/xoa/<?=$row2->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Xóa
                                                </span>
                                                <span class="ladda-spinner">
                 ...
                 <div class="card mb-3">
                        ...
                        <div class="card-body py-3">        
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold"><?=$row3->ten_san_pham;?></a></div>
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_san_pham/sua/<?=$row3->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Sửa
                                                </span>
                                                <span class="ladda-spinner">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_san_pham/xoa/<?=$row3->ma_dv;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                                <span class="ladda-label">Xóa
                                                </span>
                                                <span class="ladda-spinner">
