...
<head>
    ...
    <title>Quản trị sản phẩm | Bookingcarepet</title>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    ...
                                    <div class="menu-header-content text-dark">
                                        ...
                                        <h6 class="menu-header-subtitle">You have <b>1</b> unread messages</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item-btn text-center nav-item">
                                    <a href="quan_tri_phan_hoi.html"><button class="btn-shadow btn-wide btn-pill btn btn-focus btn-sm">Xem ngay</button></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-right mr-2">
                                                                <a href="dang_nhap.html"><button class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                                </button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="app-header__menu">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="./quan_tri_book_lich.html">
                                    <i class="metismenu-icon pe-7s-id"></i>
                                    Quản trị book lịch
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                            ...
                            <li>
                                <a href="./quan_tri_phong_kham.html">
                                    <i class="metismenu-icon pe-7s-id"></i>
                                    Quản trị phòng khám
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                    ...
                                    <div class="app-inner-layout__top-pane">
                                        <div class="pane-left">
                                                ...
                                                <button class="ladda-button mb-2 mr-2 btn-pill btn btn-danger" data-style="expand-right">
                                                    <span class="ladda-label" > <a href="./them_moi_san_pham.html"> Thêm mới</a> </span>
                    ...
                    <div class="card mb-3">
                        <div class="card-header pr-0 pl-0">
                            <div class="row no-gutters align-items-center w-100">
                                <div class="col font-weight-bold pl-3">Dịch vụ cung cấp đồ cho thú cưng</div>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <a href="javascript:void(0)" class="text-big font-weight-semibold">SỮA TẮM</a></div>
                                    <div class="d-none d-md-block col-6">
                                        
                                        <div class="row no-gutters align-items-center">
                                            
                                            <div class="col-4">Mar 8, 2020</div>
                                            <div class="col-4">Admin</div>
                                            <div class="media col-3 align-items-center">
                                                 <a href="sua_san_pham.html"><button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i></button></a>
                                                
                                                <button type="button" data-type="warning" class="btn btn-warning btn-show-swal"><i class="pe-7s-trash btn-icon-wrapper"></i></button>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">ÁO KHOÁC MŨ LÔNG</a></div>
                                    <div class="d-none d-md-block col-6">
        
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-4">Feb 20, 2020</div>
                                            <div class="col-4">Admin</div>
                                            <div class="media col-3 align-items-center">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">THỨC ĂN KHÔ</a></div>
                                    <div class="d-none d-md-block col-6">
        
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-4">Feb 02, 2020</div>
                                            <div class="col-4">Admin</div>
                                            <div class="media col-3 align-items-center">
                                                 <button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i></button>
                                                <button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-warning"><i class="pe-7s-trash btn-icon-wrapper"> </i></button>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">PATE</a></div>
                                    <div class="d-none d-md-block col-6">
        
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-4">Jan 30, 2020</div>
                                            <div class="col-4">Admin</div>
                                            <div class="media col-3 align-items-center">
                                                 <button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i></button>
                                                <button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-warning"><i class="pe-7s-trash btn-icon-wrapper"> </i></button>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">VÒNG CỔ</a></div>
                                    <div class="d-none d-md-block col-6">
        
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-4">Jan 20, 2020</div>
                                            <div class="col-4">Admin</div>
                                            <div class="media col-3 align-items-center">
                                                 <button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i></button>
                                                <button class="mb-2 mr-2 btn-icon btn-icon-only btn-pill btn btn-outline-warning"><i class="pe-7s-trash btn-icon-wrapper"> </i></button>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">CÁT VỆ SINH</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">NỆM</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">LỒNG VẬN CHUYỂN</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-header pr-0 pl-0">
                            <div class="row no-gutters align-items-center w-100">
                                <div class="col font-weight-bold pl-3">Dịch vụ chăm sóc- khám chữa thú cưng</div>
                                <div class="d-none d-md-block col-6 text-muted">
                                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <a href="javascript:void(0)" class="text-big font-weight-semibold">CẮT TỈA LÔNG</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">KHÁCH  SẠN TRÔNG GIỮ</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">ĐIỀU TRỊ NẤM GHẺ</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">NHUỘM LÔNG</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">ĐIỀU TRỊ VIÊM RUỘT</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">PHỐI GIỐNG CHÓ PUG</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">PHỐI GIỐNG CHÓ POODLE TRẮNG</a></div>
                                    <div class="d-none d-md-block col-6">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row no-gutters align-items-center">
                                 <div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">TRIỆT SẢN</a></div>
                                    <div class="d-none d-md-block col-6">
