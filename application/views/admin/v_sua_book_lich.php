                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="main-card mb-2 card">
                                ...
                                <div class="card-body"><h5 class="card-title"></h5>
                                    <form method="POST" action="<?=base_url();?>admin/quan_tri_book_lich/thuc_hien_sua_book_lich">
                                        <div class="position-relative row form-group"><label  class="col-sm-2 col-form-label">Mã book lich*</label>
                                            <div class="col-sm-10"><input name="ma_book_lich"  value="<?=$book_lich->ma_book_lich;?>" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label  class="col-sm-2 col-form-label">Họ và tên *</label>
                                            <div class="col-sm-10"><input name="ho_ten"  value="<?=$book_lich->ho_ten;?>"  class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label  class="col-sm-2 col-form-label">Số điện thoại*</label>
                                            <div class="col-sm-10"><input name="sdt"  value="<?=$book_lich->sdt;?>"  class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Địa chỉ</label>
                                            <div class="col-sm-10"><input name="dia_chi" value="<?=$book_lich->dia_chi;?>" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10"><input name="email" value="<?=$book_lich->email;?>"  class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Dịch vụ</label>
                                            <div class="col-sm-10"><input name="ma_dv"type="text" class="form-control" value="<?=$book_lich->ma_dv;?>"/></div>
                                        </div>
                                        

                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Giống thú cưng</label>
                                            <div class="col-sm-10"><input name="giong_thu_cung" value="<?=$book_lich->giong_thu_cung;?>" class="form-control"></div>
                                        </div>
                                        </div>

                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Ngày khám</label>
                                            <div class="col-sm-10"><input name="ngay_kham"type="text" value="<?=$book_lich->ngay_kham;?>" data-toggle="datepicker" class="form-control" ></div>
                                        </div>
                                        <div class="position-relative row form-group"><label class="col-sm-2 col-form-label">Phòng khám</label>
                                            <div class="col-sm-10"><input name="ma_phong_kham" type="text" class="form-control" value="<?=$book_lich->ma_phong_kham;?>"></div>
                                        </div>
                                        
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2">
                                                <button class="btn btn-secondary">Submit</button>
                                                <input name="ma_book_lich" type="hidden" value="<?=$book_lich->ma_book_lich;?>">
                                            </div>
                                        </div>
                                        </div>
                                    </form>
