              ...
              <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="app-inner-layout">
                        ...
                        <div class="app-inner-layout__wrapper">
                                    ...
                                    <div class="app-inner-layout__top-pane">
                                        <div class="pane-left">
                                                ...
                                                <button class="ladda-button mb-2 mr-2 btn-pill btn btn-danger" data-style="expand-right">
                                                    <span class="ladda-label" > <a href="./quan_tri_phong_kham/them_moi_phong_kham"> Thêm mới</a> </span>
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Danh sách phòng khám</h5>
                    ...
                    <?php foreach ($phong_kham as $row1) {
                        ;?>
                                <tbody>
                                <tr>
                                <td><?=$row1->ma_phong_kham;?></td>  
